 ...
 * @access  Private
 */
router.post("/create", authenticateJWT, requireAuth, async (req, res) => {
  try {
    const {
      liveType,
      liveSubType,
 ...
 * @access  Private
 */
router.post("/:id/join", authenticateJWT, requireAuth, async (req, res) => {
  try {
 ...
 * @access  Private
 */
router.post("/:id/leave", authenticateJWT, requireAuth, async (req, res) => {
  try {
    const { userUid } = req.body;
 ...
 * @access  Private
 */
router.post("/:id/end", authenticateJWT, requireAuth, async (req, res) => {
  try {
    const liveStream = await LiveStream.findById(req.params.id);
 ...
 * @access  Private
 */
router.post("/:id/message", authenticateJWT, requireAuth, async (req, res) => {
  try {
 ...
 * @access  Private
 */
router.post("/:id/seats/:seatIndex/leave", authenticateJWT, requireAuth, async (req, res) => {
  try {
    const seatIndex = parseInt(req.params.seatIndex);
